...
<?= $this->Form->create(null, ['context' => ['validator' => 'login'],'url' => ['controller' => 'Users', 'action' => 'login']]) ?>
...
<div class="row"><div class="col-md-6"><?= $this->Form->button('Login',['class'=>'btn btn-info']) ?></div></div>
<?= $this->Form->end() ?>
